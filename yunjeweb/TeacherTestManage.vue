...
<script>
    module.exports= {
        ...
        methods:{
            ...
            initteacherTestInfos(){
                getRequest('http://localhost:8080/searchTeacherTest',this.paramsObj).then(resp=>{
                    if (resp.status==200) {
                        this.teacherTestInfos=resp.data.data;
