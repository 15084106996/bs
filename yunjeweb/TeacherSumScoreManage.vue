<template>
    <div>
        ...
        <el-dialog
            ...
            <el-progress class="teacherSumScore" :text-inside="true" :stroke-width="26" :percentage="73" status="success"></el-progress>
            <span >
                    作业成绩：
            </span>
            <el-progress class="teacherSumScore" :text-inside="true" :stroke-width="24" :percentage="65" status="exception"></el-progress>
            <span >
                    实验成绩：
            </span>
            <el-progress class="teacherSumScore" :text-inside="true" :stroke-width="22" :percentage="80" status="success"></el-progress>
            <span >
                    考试成绩：
            </span>
            <el-progress class="teacherSumScore" :text-inside="true" :stroke-width="20" :percentage="90" status="success"></el-progress>
...
<script>
    module.exports= {
        ...
        methods:{
            ...
            initteacherSumScoreInfos(){
                getRequest('http://localhost:8080/searchTeacherSumScore',this.paramsObj).then(resp=>{
                    if (resp.status==200) {
                        this.teacherSumScoreInfos=resp.data.data;
