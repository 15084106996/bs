...
public class TeacherDaoImpl implements TeacherDao {
    ...
    public List<Experiment> findTeacherExperiment(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select course.cid as cid,cname,student.stid as stid,stname,cla,score," +
                    "sumscore,details,opinion,ename,etext,kind,classranking,graderanking,submissions,sumsubmissions " +
                    "from experiment,experimentstudent,details,score,submissions,course,ranking,student where " +
                    "experimentstudent.eid=experiment.eid and experimentstudent.did=details.did and experimentstudent.sid=score.sid " +
                    "and experimentstudent.cid=course.cid and experimentstudent.rid=ranking.rid and experimentstudent.subid=submissions.subid " +
                    "and experimentstudent.stid=student.stid and  (student.stid=? or student.stname like concat('%',?,'%')) and" +
    ...
    public long getExperimentTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select count(*) as total from experiment,experimentstudent,details,score,submissions,course,ranking,student " +
                    "where experimentstudent.eid=experiment.eid and experimentstudent.did=details.did and experimentstudent.sid=score.sid and experimentstudent.cid=course.cid " +
                    "and experimentstudent.rid=ranking.rid and experimentstudent.subid=submissions.subid and experimentstudent.stid=student.stid and  " +
                    "(student.stid=? or student.stname like concat('%',?,'%')) and (course.cid=? or course.cname like concat('%',?,'%')) ");
            ps.setString(1, stIdOrName);
            ps.setString(2, stIdOrName);
            ps.setString(3, cIdOrName);
            ps.setString(4, cIdOrName);
    ...
    public List<SumScore> findTeacherSumScore(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select course.cid  as cid,cname,student.stid as stid,stname,cla,uscore,uratio," +
                    "hscore,hratio,escore,eratio,tscore,tratio,additionalscore,sumscore,classranking,graderanking  " +
                    "from sumscore,student,course where student.stid=sumscore.stid and course.cid=sumscore.cid and " +
                    "(student.stid=? or student.stname like concat('%',?,'%')) and (course.cid=? or course.cname like concat('%',?,'%')) limit ?,?");
            ps.setString(1,stIdOrName );
            ps.setString(2,stIdOrName );
            ps.setString(3,cIdOrName );
            ps.setString(4,cIdOrName );
    ...
    public long getSumScoreTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            ...
            ps = conn.prepareStatement("select count(*) as total from sumscore,student,course where student.stid=sumscore.stid " +
                    "and course.cid=sumscore.cid and (student.stid=? or student.stname like concat('%',?,'%')) and (course.cid=? or course.cname like concat('%',?,'%'))");
            ps.setString(1,stIdOrName );
            ps.setString(2,stIdOrName );
            ps.setString(3,cIdOrName );
            ps.setString(4,cIdOrName );
    ...
    public List<Test> findTeacherTest(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select course.cid as cid,cname,student.stid as stid,stname,cla,ttid,kind,score" +
                    ",sumscore,classranking,graderanking,ratio,test.ttid as ttid from test,score,course,student,ranking " +
                    "where test.cid=course.cid and test.sid=score.sid and test.stid=student.stid and test.rid=ranking.rid " +
                    "and  (student.stid=? or student.stname like concat('%',?,'%')) and (course.cid=? " +
    ...
    public long getTestTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select  count(*) as total from test,score,course,student,ranking where test.cid=course.cid " +
                    "and test.sid=score.sid and test.stid=student.stid and test.rid=ranking.rid and  (student.stid=? " +
    ...
    public long getTimeTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            ...
            ps = conn.prepareStatement("select count(*) as total from course,student,onlinetime,submissions where " +
                    "student.stid=onlinetime.stid and submissions.subid=onlinetime.subid and course.cid=onlinetime.cid " +
                    "and (student.stid=? or student.stname like concat('%',?,'%')) and (course.cid=? or course.cname like concat('%',?,'%'))");
            ps.setString(1, stIdOrName);
            ps.setString(2, stIdOrName);
            ps.setString(3, cIdOrName);
            ps.setString(4, cIdOrName);
    ...
    public List<OnlineTime> findTeacherTime(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select student.stid as stid,stname,logintime,logouttime,onlinetime,cla,sumtime," +
                    "submissions,sumsubmissions,course.cid,cname from course,student,onlinetime,submissions where student.stid=onlinetime.stid" +
                    " and submissions.subid=onlinetime.subid and course.cid=onlinetime.cid and (student.stid=? or student.stname like concat('%',?,'%')) " +
    ...
    public long getHomeworkTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            ...
            ps = conn.prepareStatement("select count(*) as total from homework,course,student,score,ranking where " +
                    "course.cid=homework.cid and student.stid=homework.stid and score.sid=homework.sid and ranking.rid=homework.rid " +
                    "and (student.stid=? or student.stname like concat('%',?,'%'))  and (course.cid=? or course.cname " +
                    "like concat('%',?,'%'))");
            ps.setString(1, stIdOrName);
            ps.setString(2, stIdOrName);
            ps.setString(3, cIdOrName);
    ...
    public List<Homework> findTeacherHomework(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select course.cid as cid,cname,student.stid as stid,stname,kind,htid,score,sumscore,classranking,graderanking,cla " +
                    "from homework,course,student,score,ranking where course.cid=homework.cid and student.stid=homework.stid and " +
                    "score.sid=homework.sid and ranking.rid=homework.rid and (student.stid=?" +
                    " or student.stname like concat('%',?,'%')) and (course.cid=? or course.cname like concat('%',?,'%')) limit ?,? ");
            ps.setString(1, stIdOrName);
            ps.setString(2, stIdOrName);
            ps.setString(3, cIdOrName);
    ...
    public List<Kind> findTeacherKind(String cIdOrName, String stIdOrName, long pageNum, String pageSize) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select course.cid as cid,cname,student.stid as stid,stname,kid,details,opinion " +
                    "from student,course,kind,details where kind.did=details.did and student.stid=kind.stid and course.cid= kind.cid " +
    ...
    public long getKindTotal(String cIdOrName, String stIdOrName) {
        ...
        try {
            conn = DBUtils.getInstance().getConnection();
            ps = conn.prepareStatement("select count(*) as total from student,course,kind,details where kind.did=details.did " +
                    "and student.stid=kind.stid and course.cid= kind.cid and (student.stid=? or student.stname like concat('%',?,'%')) " +
                    "and (course.cid=? or course.cname like concat('%',?,'%'))");
            ps.setString(1, stIdOrName);
            ps.setString(2, stIdOrName);
            ps.setString(3, cIdOrName);
